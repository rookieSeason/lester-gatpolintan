    ...
    <section className="flex flex-col-reverse min-h-screen w-screen bg-slate-50 dark:bg-[#303030] justify-center items-center sm:p-12 scroll-smooth">
      <div className="max-w-screen w-full grid md:grid-cols-2 gap-8 tracking-tight">
          ...
          <div className="sm:max-w-[700px] justify-center items-center w-full grid grid-cols-4 gap-4 px-8 text-gray-500">
            {skillset.map((skills) => {
              return (
                <div
                  key={skills.id}
                  className="flex items-center gap-8 rounded-xl shadow-lg bg-white dark:bg-[#424242] p-4 hover:-rotate-6 duration-300"
                  title={skills.name}
                >
                  <span className="text-gray-500 dark:text-gray-300 text-4xl sm:text-5xl">
                    {skills.icon}
                  </span>
        ...
        <div className="max-w-[600px] text-justify justify-center items-center px-8">
          ...
          <span className="text-md sm:text-lg text-gray-500 dark:text-gray-300">
